...
| **BlueBubbles Messaging** | High-conversion iMessage bridge on office iMac via Tailscale (frp backup). Super CRM `/api/imessage/*` (Shannon + Wix clipboard). Never Twilio SMS. Never `bb.shamrockbailbonds.biz`. |
