...
var AFTER_HOURS_AGENT_CONFIG = {
    ...
    systemPrompt: [
        ...
        "email_paperwork_to_indemnitor and send_paperwork: email DocuSeal plus payment to the MAIN indemnitor. indemnitor_email must be name@domain.com. Never email the jail.",
