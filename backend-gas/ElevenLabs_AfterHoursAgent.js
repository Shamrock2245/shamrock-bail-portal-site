...
var AFTER_HOURS_AGENT_CONFIG = {
    ...
    systemPrompt: [
        ...
        "- If the caller or bondsman says Palmetto, or the bond is written on Palmetto, pass surety_id=palmetto to send_paperwork and create_intake.",
        ...
        "- send_paperwork: Trigger SignNow packet via Netlify→GAS. Optional surety_id (osi|palmetto, default osi). Fire-and-forget after intake is created.",
