...
| `county` | County | TEXT | No | County where arrest occurred (e.g.,
"Lee County") |
...
| Field Key | Display Name | Type | Required | Description |
|-----------|--------------|------|----------|-------------|
| `documentStatus` | Document Status | TEXT | Yes | Current document status (e.g.,
"pending",
"sent",
"signed",
"completed") |
| `signNowDocumentId` | SignNow Document ID | TEXT | No | SignNow document ID for tracking |
| `signNowStatus` | SignNow Status | TEXT | No | SignNow-specific status (e.g.,
"pending",
"signed",
"declined") |
...
| Field Key | Display Name | Type | Required | Description |
|-----------|--------------|------|----------|-------------|
| `gasSyncStatus` | GAS Sync Status | TEXT | No | Sync status with Google Apps Script (e.g.,
"pending",
"synced",
"error") |
...
| Field Key | Display Name | Type | Required | Description |
|-----------|--------------|------|----------|-------------|
| `status` | Status | TEXT | Yes | Overall case status (e.g.,
"intake",
"in_progress",
"completed",
"cancelled") |
