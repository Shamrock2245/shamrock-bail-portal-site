...
1. **Indemnitor Portal** (`portal-indemnitor.k53on`)
  - Copy code from `src/pages/portal-indemnitor-complete.js`
  - Paste into Wix Code panel

1. **Staff Portal** (`portal-staff.qs9dx`)
...
1. Create new file: `signing-methods.jsw`

1. Copy code from `src/backend/signing-methods.jsw`

1. Paste into Wix Code panel
...
1. Add secret: `GAS_WEBHOOK_URL`

1. Value: `https://script.google.com/a/macros/shamrockbailbonds.biz/s/AKfycbzU7hz5OCAZkkdjOZdKK6t7K0whw65iMH-EOzxtSf7KkVCuLvy1X-Las8CgGdTMw8pOpg/exec`
...
- **GitHub Repo:** [https://github.com/Shamrock2245/shamrock-bail-portal-site](https://github.com/Shamrock2245/shamrock-bail-portal-site)

- **GAS Project:** [https://script.google.com/u/0/home/projects/12BRRdYuyVJpQODJq2-OpUhQdZ9YLt4bbAFWmOUyJPWM_EcazKTiu3dYo/edit](https://script.google.com/u/0/home/projects/12BRRdYuyVJpQODJq2-OpUhQdZ9YLt4bbAFWmOUyJPWM_EcazKTiu3dYo/edit)

- **Google Sheets:** [https://docs.google.com/spreadsheets/d/121z5R6Hpqur54GNPC8L26ccfDPLHTJc3_LU6G7IV_0E/edit](https://docs.google.com/spreadsheets/d/121z5R6Hpqur54GNPC8L26ccfDPLHTJc3_LU6G7IV_0E/edit)

- **Implementation Guide:** `docs/PORTAL_WIRING_IMPLEMENTATION.md`

- **Wix Velo Docs:** [https://www.wix.com/velo/reference](https://www.wix.com/velo/reference)

- **SignNow API:** [https://docs.signnow.com](https://docs.signnow.com)
